...
export default function AdvertisementSlider() {
  ...
  return (
    <div className="my-10 bg-gray-100 rounded-lg">
      ...
      <div className="w-fit rounded-full p-2"><h2 className="text-md max-md:text-sm font-bold text-red-600 animate-pulse"><a href="tel:+916395438784">Contact for advertisements: +91 6395438784</a></h2></div>
